    ...
    <>
      <div className="row mt-5">
        <div className="col-12">
          ...
          <p className="text-end text-secondary fst-italic">
            ...
            fessura che lo divide in due e che rumini potrete mangiarlo." <span className="text-nowrap">Levitico (11, 2:3)</span>
          </p>
        </div>
      ...
      <div className="row mt-5 text-end">
        ...
        <div className="d-flex justify-content-around my-4 w-100">
          <img className="img-fluid w-xs-25 w-xl-10 my-auto" src="/resources/koshers/okk.jpg" alt="..." />
          <img className="img-fluid w-xs-25 w-xl-10 my-auto" src="/resources/koshers/ou.svg" alt="..." />
          <img className="img-fluid w-xs-25 w-xl-10 my-auto" src="/resources/koshers/euk.jpg" alt="..." />
        </div>

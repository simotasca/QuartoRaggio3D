...
function MenuItem(props) {
  return (
    <MyLink href={props.href} className={[styles.wonderLeyen, props.active ? styles.wonderLeyenActv : ""].join(" ")}>
...
function SidePanel({children, show, handleClose}) {
  return (
    <>
      ...
      <div className={styles.offcanvasBlur} style={show?{}:{background: "transparent", zIndex: "-1"}} onClick={handleClose} />
    </>
  );
}
